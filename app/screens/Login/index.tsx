    ...
    return (
        <>
            <Container
                ...
                />
                <InputContainer>
                    <SantaInputCPFObfuscated clearable={false} label="CPF" text={ownerCPF} setText={() => {}} />
                </InputContainer>
                <Image
                ...
                />
                <InputContainer>
                    <SantaInputPassword clearable={false} text={password} setText={setPassword} label="Senha" />
                </InputContainer>
                <Image
